...
public class ClickDrag : MonoBehaviour
{
    ...
    private bool freeSlotLeft = false;
        ...
        if (Input.GetMouseButtonUp(0)) // when mouse button is released
        {
            if (currentItem != null) // if the current item exists
            {
                ...
                if (swapSlot == null || currentItem == nearestSlot.item || nearestSlot.item == null) // If there is no item in swap slot or the item held is equal to the nearest slot or the nearest slot has no item
                {
                    ...
                    Image image = assetTransform.Find("Icon").GetComponent<Image>(); // Creates an object refering to the image componenet of the "Icon" game object using the rect transform of the parent object to find it
                    image.sprite = currentItem.icon; // set the sprite of the closest crafting slot to the sprite of the current item held
                    TextMeshProUGUI itemText = assetTransform.Find("Amount").GetComponent<TextMeshProUGUI>(); // Creates an object refering to the text component of the "Amount" game object using the rect transform of the parent to find it
                ...
                else
                {
                    ...
                    RectTransform swapAssetTransform = swapSlotTransform.Find("Assets").GetComponent<RectTransform>();
                    ...
                    swapAssetTransform.gameObject.SetActive(true); // set the closest crafting slot to visible
                    ...
                    Image swapImage = swapAssetTransform.Find("Icon").GetComponent<Image>(); // Creates an object refering to the image component of the "Icon" game object using the rect transform of the parent objet to find it
                    swapImage.sprite = swapSlot.item.icon; // set the sprite of the closest crafting slot to the sprite of the current item held
                    TextMeshProUGUI swapItemText = swapAssetTransform.Find("Amount").GetComponent<TextMeshProUGUI>();// Creates an object refering to the text component of the "Amount" game object using the rect transform of the parent to find it
                    ...
                    assetTransform.gameObject.SetActive(true); // set the closest crafting slot to visible
                    ...
                    Image image = assetTransform.Find("Icon").GetComponent<Image>();// Creates an object refering to the image component of the "Icon" game object using the rect transform of the parent objet to find it
                    image.sprite = currentItem.icon; // set the sprite of the closest crafting slot to the sprite of the current item held
                    TextMeshProUGUI itemText = assetTransform.Find("Amount").GetComponent<TextMeshProUGUI>();// Creates an object refering to the text component of the "Amount" game object using the rect transform of the parent to find it
    ...
    {
        RectTransform cursorTransform = customCursor.GetComponent<RectTransform>();
        ...
        if (currentItem == null) // if current item is null
        {
            ...
            canvasGroupA.blocksRaycasts = false;
            */
            Image image = cursorTransform.Find("Icon").GetComponent<Image>();
            image.sprite = currentItem.icon; // change cursor sprite to item clicked
            customCursor.itemAmount = slot.itemAmount;
            TextMeshProUGUI itemText = cursorTransform.Find("Amount").GetComponent<TextMeshProUGUI>();
